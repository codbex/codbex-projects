...
class ProjectService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-projects.Project.ProjectReadOnly") || user.isInRole("codbex-projects.Project.ProjectFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-projects.Project.ProjectFullAccess")) {
            throw new ForbiddenError();
        }
    }
