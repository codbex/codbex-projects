...
class DeliverableService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-projects.Deliverable.DeliverableReadOnly") || user.isInRole("codbex-projects.Deliverable.DeliverableFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-projects.Deliverable.DeliverableFullAccess")) {
            throw new ForbiddenError();
        }
    }
