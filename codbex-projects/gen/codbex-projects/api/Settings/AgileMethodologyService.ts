...
const validationModules = await Extensions.loadExtensionModules("codbex-projects-Settings-AgileMethodology", ["validate"]);

@Controller
class AgileMethodologyService {

    private readonly repository = new AgileMethodologyRepository();
    ...
    public getById(_: any, ctx: any) {
        try {
            ...
            if (entity) {
                ...
                HttpUtils.sendResponseNotFound("AgileMethodology not found");
            }
        } catch (error: any) {
            this.handleError(error);
        }
