...
import { IterationLenghtRepository, IterationLenghtEntityOptions } from "../../dao/entities/IterationLenghtRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-projects-entities-IterationLenght", ["validate"]);
...
class IterationLenghtService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-projects/gen/codbex-projects/api/entities/IterationLenghtService.ts/" + entity.Id);
