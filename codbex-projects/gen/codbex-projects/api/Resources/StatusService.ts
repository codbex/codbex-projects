...
import { StatusRepository, StatusEntityOptions } from "../../dao/Resources/StatusRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-projects-Resources-Status", ["validate"]);
...
class StatusService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-projects/gen/codbex-projects/api/Resources/StatusService.ts/" + entity.Id);
