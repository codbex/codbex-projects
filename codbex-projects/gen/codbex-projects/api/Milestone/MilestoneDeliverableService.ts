...
class MilestoneDeliverableService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-projects.Milestone.MilestoneDeliverableReadOnly") || user.isInRole("codbex-projects.Milestone.MilestoneDeliverableFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-projects.Milestone.MilestoneDeliverableFullAccess")) {
            throw new ForbiddenError();
        }
    }
