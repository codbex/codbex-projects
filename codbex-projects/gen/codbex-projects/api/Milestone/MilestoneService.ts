...
class MilestoneService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-projects.Milestone.MilestoneReadOnly") || user.isInRole("codbex-projects.Milestone.MilestoneFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-projects.Milestone.MilestoneFullAccess")) {
            throw new ForbiddenError();
        }
    }
