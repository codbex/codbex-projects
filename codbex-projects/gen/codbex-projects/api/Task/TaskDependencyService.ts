...
import { TaskDependencyRepository, TaskDependencyEntityOptions } from "../../dao/Task/TaskDependencyRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-projects-Task-TaskDependency", ["validate"]);
...
class TaskDependencyService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-projects/gen/codbex-projects/api/Task/TaskDependencyService.ts/" + entity.Id);
