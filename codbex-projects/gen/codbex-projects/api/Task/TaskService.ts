...
import { TaskRepository, TaskEntityOptions } from "../../dao/Task/TaskRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-projects-Task-Task", ["validate"]);
...
class TaskService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-projects/gen/codbex-projects/api/Task/TaskService.ts/" + entity.Id);
