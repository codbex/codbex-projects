...
export class MilestoneReportRepository {
    ...
    private async triggerEvent(data: MilestoneReportEntityEvent | MilestoneReportUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-MilestoneReport-MilestoneReport", ["trigger"]);
        ...
        producer.topic("codbex-projects-MilestoneReport-MilestoneReport").send(JSON.stringify(data));
    }
}
