...
export class TaskRepository {
    ...
    private async triggerEvent(data: TaskEntityEvent | TaskUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-Deliverable-Task", ["trigger"]);
        ...
        producer.topic("codbex-projects-Deliverable-Task").send(JSON.stringify(data));
    }
}
