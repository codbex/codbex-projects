...
export class DependencyTypeRepository {
    ...
    private async triggerEvent(data: DependencyTypeEntityEvent | DependencyTypeUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-Settings-DependencyType", ["trigger"]);
        ...
        producer.topic("codbex-projects-Settings-DependencyType").send(JSON.stringify(data));
    }
}
