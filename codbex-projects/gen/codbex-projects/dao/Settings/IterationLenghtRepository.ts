...
export class IterationLenghtRepository {
    ...
    private async triggerEvent(data: IterationLenghtEntityEvent | IterationLenghtUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-Settings-IterationLenght", ["trigger"]);
        ...
        producer.topic("codbex-projects-Settings-IterationLenght").send(JSON.stringify(data));
    }
}
