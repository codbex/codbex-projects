...
export interface MemberRoleEntityEvent {
...
export interface MemberRoleUpdateEntityEvent extends MemberRoleEntityEvent {
...
export class MemberRoleRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(MemberRoleRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: MemberRoleEntityOptions = {}): MemberRoleEntity | undefined {
    ...
    private async triggerEvent(data: MemberRoleEntityEvent | MemberRoleUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-Settings-MemberRole", ["trigger"]);
        ...
        producer.topic("codbex-projects-Settings-MemberRole").send(JSON.stringify(data));
    }
}
