...
export class StatusTypeRepository {
    ...
    private async triggerEvent(data: StatusTypeEntityEvent | StatusTypeUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-Settings-StatusType", ["trigger"]);
        ...
        producer.topic("codbex-projects-Settings-StatusType").send(JSON.stringify(data));
    }
}
