...
export interface ResourceTypeEntityEvent {
...
export interface ResourceTypeUpdateEntityEvent extends ResourceTypeEntityEvent {
...
export class ResourceTypeRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(ResourceTypeRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: ResourceTypeEntityOptions = {}): ResourceTypeEntity | undefined {
    ...
    private async triggerEvent(data: ResourceTypeEntityEvent | ResourceTypeUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-Settings-ResourceType", ["trigger"]);
        ...
        producer.topic("codbex-projects-Settings-ResourceType").send(JSON.stringify(data));
    }
}
