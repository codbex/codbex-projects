...
export class AgileMethodologyTypeRepository {
    ...
    private async triggerEvent(data: AgileMethodologyTypeEntityEvent | AgileMethodologyTypeUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-entities-AgileMethodologyType", ["trigger"]);
        ...
        producer.topic("codbex-projects-entities-AgileMethodologyType").send(JSON.stringify(data));
    }
}
