...
export class CostCategoryRepository {
    ...
    private async triggerEvent(data: CostCategoryEntityEvent | CostCategoryUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-entities-CostCategory", ["trigger"]);
        ...
        producer.topic("codbex-projects-entities-CostCategory").send(JSON.stringify(data));
    }
}
