...
export class ExpenseCategoryRepository {
    ...
    private async triggerEvent(data: ExpenseCategoryEntityEvent | ExpenseCategoryUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-entities-ExpenseCategory", ["trigger"]);
        ...
        producer.topic("codbex-projects-entities-ExpenseCategory").send(JSON.stringify(data));
    }
}
