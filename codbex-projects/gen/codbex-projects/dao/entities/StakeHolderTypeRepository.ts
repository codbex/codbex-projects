...
export class StakeHolderTypeRepository {
    ...
    private async triggerEvent(data: StakeHolderTypeEntityEvent | StakeHolderTypeUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-entities-StakeHolderType", ["trigger"]);
        ...
        producer.topic("codbex-projects-entities-StakeHolderType").send(JSON.stringify(data));
    }
}
