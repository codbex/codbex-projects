...
export class BudgetRepository {
    ...
    private async triggerEvent(data: BudgetEntityEvent | BudgetUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-projects-entities-Budget", ["trigger"]);
        ...
        producer.topic("codbex-projects-entities-Budget").send(JSON.stringify(data));
    }
}
